            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 text-xs font-black text-foreground">
                  ...
                  <span className="font-medium text-muted-foreground text-[10px]">{f.flightNum}</span>
                  {f.stops > 0 && (
                    <span className="text-[10px] font-medium text-muted-foreground">{f.stops} stop{f.stops > 1 ? "s" : ""}</span>
                  )}
                </div>
              ...
              <div className="text-right shrink-0 flex flex-col items-end gap-0.5">
                {f.price > 0 && <p className="text-sm font-black text-foreground">${f.price}</p>}
