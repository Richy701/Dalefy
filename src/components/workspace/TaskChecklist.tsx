...
export function TaskChecklist({ tasks, onUpdate, travelers }: TaskChecklistProps) {
  ...
  return (
    <div className="flex flex-col h-full">
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 [@media(hover:none)]:opacity-100 h-6 w-6 rounded-md flex items-center justify-center text-muted-foreground hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-all shrink-0"
              >
      ...
      {/* Add task form */}
      {showForm ? (
        <div className="p-3 border-t border-border space-y-2.5 bg-secondary/50/50">
          <input
            autoFocus
            value={newTitle}
            ...
            className="w-full h-9 px-3 rounded-lg text-xs font-semibold bg-card border border-border text-foreground placeholder:text-slate-400 dark:placeholder:text-[#555] focus:outline-none focus:border-brand transition-colors"
          />
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <select
                ...
                className="text-[10px] font-bold uppercase bg-transparent border-none text-muted-foreground focus:outline-none cursor-pointer"
              >
                {CATEGORIES.map(c => (
            ...
            <Popover>
              ...
              <PopoverContent align="start" className="w-auto p-0 border border-border shadow-2xl rounded-xl bg-card">
            ...
            {travelers && travelers.length > 0 && (
              <div className="flex items-center gap-1">
                ...
                <select
                  ...
                  className="text-[10px] font-bold uppercase bg-transparent border-none text-muted-foreground focus:outline-none cursor-pointer max-w-[80px]"
                >
