            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                  ...
                  {r.priceTag && <span className="text-[10px] text-slate-500 dark:text-muted-foreground">{r.priceTag}</span>}
                  {r.cuisines?.length > 0 && <span className="text-[10px] text-slate-500 dark:text-muted-foreground">{r.cuisines.join(", ")}</span>}
                </div>
              </div>
