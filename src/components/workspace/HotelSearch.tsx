          ...
          <div className="sm:flex-1 sm:min-w-[115px]">
            ...
            <Popover>
              <PopoverTrigger className={`${inputCls} flex items-center justify-between gap-2 text-left whitespace-nowrap overflow-hidden`}>
                ...
                <CalendarIcon className="h-4 w-4 sm:h-3.5 sm:w-3.5 text-muted-foreground shrink-0" />
              </PopoverTrigger>
          ...
          {results.map((h, i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-black text-foreground truncate">{h.name}</p>
                <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                  ...
                  {h.reviews > 0 && <span className="text-[10px] text-muted-foreground">({h.reviews.toLocaleString()})</span>}
                  {h.stars && <span className="text-[10px] text-muted-foreground">· {h.stars}</span>}
                </div>
              </div>
