      ...
      <DialogContent className="max-w-md bg-white dark:bg-[#111111] rounded-xl border border-slate-200 dark:border-[#1f1f1f] p-6 shadow-2xl">
        ...
        <DialogFooter className="pt-4 flex gap-3">
          ...
          <Button
            ...
            disabled={busy}
            className={`rounded-xl h-10 px-8 font-bold uppercase tracking-wider shadow-xl ${destructive ? 'bg-destructive hover:bg-destructive/90 text-white' : 'bg-brand hover:opacity-90 text-black shadow-brand/20'}`}
          >
