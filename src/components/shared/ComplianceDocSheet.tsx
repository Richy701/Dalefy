...
import { FileText, FileDashed, FileX, SpinnerGap, SealCheck, ArrowRight, Info } from "@phosphor-icons/react";
...
export function ComplianceDocSheet({ open, onOpenChange, doc, travelerName, onSign }: ComplianceDocSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-[calc(100vw-2rem)] max-w-[400px] sm:max-w-[480px] sm:w-[480px] p-0 bg-white dark:bg-[#080808] border-l border-border shadow-2xl" showCloseButton>
        <div className="flex flex-col h-full">
          {/* Refined Header */}
          <div className="p-10 pb-8 bg-slate-50/50 dark:bg-[#0c0c0c] border-b border-border">
              ...
              {content ? (
                <div className="space-y-10">
                  <div className="relative">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed font-medium pl-2">
                      {content.preamble}
                    </p>
                  </div>
          ...
          {/* Action Footer */}
          {!isSigned && (
            <div className="p-10 border-t border-border bg-slate-50/50 dark:bg-[#0c0c0c]">
