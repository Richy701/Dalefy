...
export const INITIAL_TRIPS: Trip[] = [
  {
    ...
    travelerIds: ["t1", "t2", "t4"],
    start: "2026-03-17",
    end: "2026-03-24",
    status: "In Progress",
    image: "https://images.unsplash.com/photo-1523805009345-7448845a9e53?q=80&w=1000&auto=format&fit=crop",
    media: [
      { id: "m1", type: "image", name: "Safari sunset.jpg", url: "https://images.unsplash.com/photo-1516426122078-c23e76319801?q=80&w=800&auto=format&fit=crop", size: 2400000, uploadedAt: "2026-03-18T16:30:00Z", uploadedBy: "Sophia Chen" },
      { id: "m2", type: "image", name: "Elephant herd.jpg", url: "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?q=80&w=800&auto=format&fit=crop", size: 1800000, uploadedAt: "2026-03-19T10:15:00Z", uploadedBy: "Marcus Johnson" },
      { id: "m3", type: "image", name: "Hot air balloon.jpg", url: "https://images.unsplash.com/photo-1493246507139-91e8fad9978e?q=80&w=800&auto=format&fit=crop", size: 3100000, uploadedAt: "2026-03-20T06:45:00Z", uploadedBy: "Sophia Chen" },
      { id: "m4", type: "image", name: "Kilimanjaro view.jpg", url: "https://images.unsplash.com/photo-1621414050946-1b936a78431d?q=80&w=800&auto=format&fit=crop", size: 2700000, uploadedAt: "2026-03-22T17:00:00Z", uploadedBy: "Liam O'Brien" },
    ],
    events: [
      ...
      { id: "e2m", type: "hotel", date: "2026-03-22", time: "12:00 PM", title: "Tortilis Camp", location: "Amboseli National Park", image: "https://images.unsplash.com/photo-1493246507139-91e8fad9978e?q=80&w=500&auto=format&fit=crop", checkin: "12:00 PM", checkout: "10:00 AM", roomType: "Private Tent with Kilimanjaro View", confNumber: "TRC-56710", status: "Confirmed" },
  ...
  },
  {
    ...
    travelerIds: ["t3", "t5", "t8"],
    start: "2026-05-10",
    end: "2026-05-20",
    status: "Draft",
    image: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=1000&auto=format&fit=crop",
    media: [
      { id: "m5", type: "image", name: "Tokyo skyline.jpg", url: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?q=80&w=800&auto=format&fit=crop", size: 2100000, uploadedAt: "2026-05-10T21:00:00Z", uploadedBy: "Amara Osei" },
      { id: "m6", type: "image", name: "Fushimi Inari gates.jpg", url: "https://images.unsplash.com/photo-1545569341-9eb8b30979d9?q=80&w=800&auto=format&fit=crop", size: 1600000, uploadedAt: "2026-05-14T07:30:00Z", uploadedBy: "Priya Sharma" },
    ],
    events: [
      ...
      { id: "e9", type: "hotel", date: "2026-05-13", time: "12:00 PM", title: "The Ritz-Carlton Kyoto", location: "Kamogawa, Kyoto", image: "https://images.unsplash.com/photo-1545569341-9eb8b30979d9?q=80&w=500&auto=format&fit=crop", checkin: "3:00 PM", checkout: "12:00 PM", roomType: "Garden Terrace Suite", confNumber: "RCK-77432", status: "Confirmed" },
  ...
  },
  {
    ...
    media: [
      { id: "m7", type: "image", name: "Overwater villa.jpg", url: "https://images.unsplash.com/photo-1573843981267-be1999ff37cd?q=80&w=800&auto=format&fit=crop", size: 2900000, uploadedAt: "2026-06-16T14:00:00Z", uploadedBy: "Ash Murray" },
      { id: "m8", type: "image", name: "Dolphin cruise.jpg", url: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=800&auto=format&fit=crop", size: 1500000, uploadedAt: "2026-06-17T08:00:00Z", uploadedBy: "Priya Sharma" },
      { id: "m9", type: "image", name: "Sandbank dinner.jpg", url: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?q=80&w=800&auto=format&fit=crop", size: 2200000, uploadedAt: "2026-06-18T20:00:00Z", uploadedBy: "Ash Murray" },
    ],
    events: [
  ...
  },
  {
    ...
    travelerIds: ["t7", "t2", "t4"],
    start: "2026-09-05",
    end: "2026-09-12",
    status: "Draft",
    image: "https://images.unsplash.com/photo-1633321088355-d0f81134ca3b?q=80&w=1000&auto=format&fit=crop",
    media: [
      { id: "m10", type: "image", name: "Positano coast.jpg", url: "https://images.unsplash.com/photo-1602343168117-bb8ffe3e2e9f?q=80&w=800&auto=format&fit=crop", size: 2000000, uploadedAt: "2026-09-06T11:00:00Z", uploadedBy: "Elena Rossi" },
      { id: "m11", type: "image", name: "Capri boat trip.jpg", url: "https://images.unsplash.com/photo-1633321088355-d0f81134ca3b?q=80&w=800&auto=format&fit=crop", size: 1700000, uploadedAt: "2026-09-06T15:30:00Z", uploadedBy: "Marcus Johnson" },
    ],
    events: [
  ...
  },
  {
    ...
    travelerIds: ["t1", "t3", "t8"],
    start: "2026-09-14",
    end: "2026-09-20",
    status: "Published",
    image: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?q=80&w=1000&auto=format&fit=crop",
    media: [
      { id: "m12", type: "image", name: "Blue Lagoon.jpg", url: "https://images.unsplash.com/photo-1515862122574-ef0e28b1bef1?q=80&w=800&auto=format&fit=crop", size: 2300000, uploadedAt: "2026-09-14T16:30:00Z", uploadedBy: "Sophia Chen" },
      { id: "m13", type: "image", name: "Gullfoss waterfall.jpg", url: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?q=80&w=800&auto=format&fit=crop", size: 2800000, uploadedAt: "2026-09-15T12:00:00Z", uploadedBy: "James Whitfield" },
      { id: "m14", type: "image", name: "Glacier walk.jpg", url: "https://images.unsplash.com/photo-1504893524553-b855bce32c67?q=80&w=800&auto=format&fit=crop", size: 1900000, uploadedAt: "2026-09-16T11:00:00Z", uploadedBy: "Amara Osei" },
    ],
    events: [
  ...
  },
  {
    ...
    travelerIds: ["t3", "t5", "t6", "t7"],
    start: "2026-11-01",
    end: "2026-11-10",
    status: "In Progress",
    image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=1000&auto=format&fit=crop",
    media: [
      { id: "m15", type: "image", name: "Rice terraces.jpg", url: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=800&auto=format&fit=crop", size: 2500000, uploadedAt: "2026-11-03T08:00:00Z", uploadedBy: "Amara Osei" },
      { id: "m16", type: "image", name: "Uluwatu temple.jpg", url: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=800&auto=format&fit=crop", size: 2100000, uploadedAt: "2026-11-06T10:30:00Z", uploadedBy: "Elena Rossi" },
    ],
    events: [
      ...
      { id: "e47", type: "hotel", date: "2026-11-05", time: "12:00 PM", title: "AYANA Resort Bali", location: "Jimbaran, Bali", image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=500&auto=format&fit=crop", checkin: "2:00 PM", checkout: "12:00 PM", roomType: "Ocean View Suite", confNumber: "AYN-88741", status: "Confirmed" },
  ...
  },
  {
    ...
    travelerIds: ["t2", "t7", "t8"],
    start: "2027-01-15",
    end: "2027-01-22",
    status: "Draft",
    image: "https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?q=80&w=1000&auto=format&fit=crop",
    media: [
      { id: "m17", type: "image", name: "Jungfraujoch summit.jpg", url: "https://images.unsplash.com/photo-1520769669658-f07657f5a307?q=80&w=800&auto=format&fit=crop", size: 2600000, uploadedAt: "2027-01-16T12:00:00Z", uploadedBy: "Marcus Johnson" },
    ],
    events: [
      ...
      { id: "e54", type: "hotel", date: "2027-01-15", time: "03:00 PM", title: "Victoria-Jungfrau Grand Hotel", location: "Interlaken, Switzerland", image: "https://images.unsplash.com/photo-1520769669658-f07657f5a307?q=80&w=500&auto=format&fit=crop", checkin: "3:00 PM", checkout: "11:00 AM", roomType: "Jungfrau View Suite", confNumber: "VJG-30281", status: "Confirmed" },
  ...
  },
  {
    ...
    travelerIds: ["t1", "t4", "t8"],
    start: "2026-05-05",
    end: "2026-05-09",
    status: "Published",
    image: "https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?q=80&w=1000&auto=format&fit=crop",
    media: [
      { id: "m18", type: "image", name: "Brooklyn Bridge.jpg", url: "https://images.unsplash.com/photo-1534430480872-3498386e7856?q=80&w=800&auto=format&fit=crop", size: 1800000, uploadedAt: "2026-05-06T15:00:00Z", uploadedBy: "Sophia Chen" },
      { id: "m19", type: "image", name: "Central Park.jpg", url: "https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?q=80&w=800&auto=format&fit=crop", size: 2000000, uploadedAt: "2026-05-08T11:30:00Z", uploadedBy: "Liam O'Brien" },
    ],
    events: [
      ...
      { id: "e63", type: "hotel", date: "2026-05-05", time: "05:00 PM", title: "The Standard, High Line", location: "Meatpacking District, NYC", image: "https://images.unsplash.com/photo-1534430480872-3498386e7856?q=80&w=500&auto=format&fit=crop", checkin: "4:00 PM", checkout: "11:00 AM", roomType: "Hudson River View King", confNumber: "SHL-65023", status: "Confirmed" },
