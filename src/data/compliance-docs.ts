...
export const COMPLIANCE_DOC_CONTENT: Record<string, DocContent> = {
  Passport: {
    ...
    preamble: "This declaration confirms that the traveller's passport details have been verified and are valid for all planned travel destinations.",
    sections: [
      {
  ...
  "Travel Insurance": {
    ...
    preamble: "This document confirms the traveller's understanding of the company travel insurance policy and their obligations while travelling on company business.",
    sections: [
      {
  ...
  "Behavioural Agreement": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "I agree to respect local customs, dress codes, and cultural practices at all destinations. I will follow any cultural briefings provided before travel and act with sensitivity when visiting religious sites, local communities, or culturally significant locations. I understand that culturally insensitive behaviour reflects poorly on the company and may impact supplier relationships.",
      },
      {
        heading: "4. Social Media & Confidentiality",
        body: "I agree to follow the company's social media policy when posting content related to company trips. I will not share confidential pricing, supplier agreements, or client information on any platform. All photography and video content shared publicly must be approved by the marketing team and must not include images of individuals without their consent.",
      },
      {
        heading: "5. Consequences of Breach",
        body: "I understand that any breach of this behavioural agreement may result in disciplinary action, which could include formal warnings, removal from current or future trips, or termination of employment depending on the severity of the breach. All incidents will be reviewed by HR in accordance with the company disciplinary procedure.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "I confirm that I have read and understood the company's anti-bribery and corruption policy. I will not offer, promise, give, request, or accept any bribe or facilitation payment in connection with my work. I understand that this applies to all interactions with clients, suppliers, government officials, and any third parties.",
      },
      {
      ...
      },
      {
        ...
        body: "I agree to comply with all health and safety procedures during company travel. I will attend safety briefings, follow emergency procedures, use safety equipment where provided, and report any hazards or near-misses to the trip leader immediately. I understand that my safety and the safety of my colleagues is a shared responsibility.",
      },
      {
        heading: "4. Whistleblowing",
        body: "I am aware of the company's whistleblowing policy and understand that I can report concerns about illegal or unethical behaviour confidentially without fear of retaliation. Reports can be made to HR, the compliance team, or via the anonymous reporting line detailed in the employee handbook.",
      },
    ],
  },
  ...
  "Risk Assessment": {
    ...
    preamble: "This document confirms that the traveller has reviewed the risk assessment for their assigned destination(s) and understands the identified risks and mitigation measures.",
    sections: [
      {
        heading: "1. Destination Risk Review",
        body: "I confirm that I have reviewed the destination risk assessment provided by the operations team, including FCDO travel advice, health risks, security considerations, and any destination-specific warnings. I understand the current risk level assigned to my destination and accept the identified residual risks.",
      },
      {
        heading: "2. Health Precautions",
        body: "I confirm that I have obtained or am in the process of obtaining all recommended vaccinations and health precautions for my assigned destination(s). I have reviewed the health advisory and understand any medication requirements, food and water safety guidance, and altitude or climate considerations.",
      },
      {
        heading: "3. Emergency Procedures",
        body: "I have noted the emergency contact details for my destination, including the local emergency services number, the nearest British Embassy or Consulate, the company 24-hour emergency line, and the travel insurance emergency assistance number. I understand the company's emergency escalation procedure.",
      },
      {
        heading: "4. Personal Responsibility",
        body: "I agree to exercise reasonable caution while at the destination, avoid high-risk areas identified in the risk assessment, keep my personal belongings secure, and maintain communication with the trip leader. I will not travel to areas advised against by the FCDO or the company without explicit written approval from the operations director.",
      },
    ],
  },
};
